...
export default function PrintButton() {
  return (
    <button
      ...
      className="no-print inline-flex items-center gap-2 border border-signal/50 bg-signal/10 px-5 py-2.5 text-sm text-signal transition-colors hover:border-ink hover:text-ink"
    >
